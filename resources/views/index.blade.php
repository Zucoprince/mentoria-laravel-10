...
<link href="{{ asset ('css/bootstrap.css') }}" rel="stylesheet">
    ...
    <!-- Favicons -->
<link rel="apple-touch-icon" href="{{ asset('icones/Ass-Pedro-Zucolo.png')}}" sizes="180x180">
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  ...
  <div id="navbarSearch" class="navbar-search w-100 collapse">
    ...
    @yield('scripts')
    <script src="/js/bootstrap.bundle.min.js" integrity="sha384-8EuqQPVKNUbKy6CGsY3UGUWfC6QcQ3dUPiIXRU5neAHaoR0nvpSR/HZ702AghMmf"></script>
